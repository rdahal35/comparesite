# Generated by Django 2.0.3 on 2018-03-27 15:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_cost', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='USD', max_digits=11)),
                ('mobile_battery', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compare.Battery')),
                ('mobile_display', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compare.Dispaly')),
                ('mobile_extraFeature', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compare.extraFeatures')),
            ],
        ),
        migrations.CreateModel(
            name='Processor',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compare.Processor'),
        ),
        migrations.AddField(
            model_name='mobile',
            name='mobile_software',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compare.Software'),
        ),
        migrations.AddField(
            model_name='mobile',
            name='moblie_camera',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compare.Camera'),
        ),
    ]
