...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Lens', models.CharField(default='-', max_length=50)),
                ('Resolution', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
                ('Flash', models.CharField(max_length=10)),
                ('Secondary_camera', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Company',
        ...
        migrations.AddField(
            model_name='mobile',
            name='mobile_processor',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compare.Processor', verbose_name='Processor'),
        ),
        migrations.AddField(
            model_name='mobile',
            name='mobile_software',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compare.Software', verbose_name='Software'),
        ),
        migrations.AddField(
            model_name='mobile',
            name='moblie_camera',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='compare.Camera', verbose_name='Camera'),
        ),
    ]
